...
/** 
 * Updated by JCasGen Wed Dec 12 23:28:16 EST 2018
 * XML source: C:/Users/suvarna/Documents/rhit-xprize-pipeline/desc/PointingDataAnnotatorDescriptor.xml
 * @generated */
public class Pointing extends Annotation {
   ...
   * @generated */
  protected Pointing() {/* intentionally empty block */}
  ...
  */  
  ...
  public String getConfidence() {
	    if (Pointing_Type.featOkTst && ((Pointing_Type)jcasType).casFeat_confidence == null)
	      ...
	      return jcasType.ll_cas.ll_getStringValue(addr, ((Pointing_Type)jcasType).casFeatCode_confidence);
  }
  ...
  public void setConfidence(String v) {
	    if (Pointing_Type.featOkTst && ((Pointing_Type)jcasType).casFeat_confidence == null)
	        jcasType.jcas.throwFeatMissing("confidence", "edu.rosehulman.aixprize.pipeline.types.Pointing");
	      jcasType.ll_cas.ll_setStringValue(addr, ((Pointing_Type)jcasType).casFeatCode_confidence, v);}    
